        ...
        <NewCardComp>
          <div className="px-2 text-center">
            ...
            <h4 className="font-medium">
              Tired of the same old launchpad routines? Say hello to Bundle Bee,
              where innovation meets opportunity.
              <br />
              We're not just another launchpad; we're your strategic partner in
              the bustling world of Solana Meme projects.
            </h4>
            <br />
            <h3 className="text-center pb-2 mb-4 text-2xl">Why Bundle Bee?</h3>
            <ul className="list-item list-inside text-left mx-auto w-2/3 text-lg font-medium">
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
                <strong className="text-yellow-600">Strategic Launches</strong>:
                We bundle launches to secure better positioning for developers,
                steering clear of snipers. It's about strategic placement, not
                just speed.
              </li>
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
                <strong className="text-yellow-600">Cost-Effective</strong>: We
                pride ourselves on being the most cost-effective launchpad on
                the market. With JITO, we empower teams to keep more of what
                they earn.
              </li>
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
                <strong className="text-yellow-600">Beyond the Pump</strong>:
                Tired of the 'pump and dump' culture? We are too. Bundle Bee is
                committed to fostering sustainable projects, not transient hype.
              </li>
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
            ...
            <ul className="list-disc list-inside text-left mx-auto w-2/3 text-lg font-medium space-y-2">
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
                ...
                robust platform to launch with confidence. We provide tools and
                support to ensure your project stands out and succeeds.
              </li>
              <li className="bg-gray-800 text-white p-4 rounded-lg shadow-md mb-2 hover:bg-gray-700 transition duration-300">
            ...
            <ul>
              <li>
                Whether you're a developer looking to launch your next big thing
                or a user eager to explore new tools, Bundle Bee is where you
                belong. Let's build, launch, and succeed together on Solana!
              </li>
            </ul>
