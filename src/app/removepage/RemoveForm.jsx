...
const BurnFormComp = () => {
  ...
  const burnLP = async (e) => {
    ...
    if (!mint.trim()) {
      toast.error("Token Address is required to Remove LP");
      return;
    }
    const obj = {
      mint,
          ...
          <form className="w-full max-w-2xl my-3">
            <div className="flex flex-wrap -mx-3 mb-3">
              <div className="w-full px-3 mb-6 md:mb-0">
                ...
                <input
                  className="appearance-none block w-[450px] bg-[#878787] text-white border-2 py-1 px-4 mb-3 border-custom_bg"
                  id="mint"
                  name="mint"
                  type="text"
            ...
            <div className="flex flex-wrap -mx-3 mb-3">
              <div className="w-full px-3 mb-6 md:mb-0">
                ...
                <input
                  className="appearance-none block w-full bg-[#878787] text-white border-2 py-1 px-4 mb-3 border-custom_bg"
                  id="pairAddress"
                  name="pairAddress"
                  type="text"
