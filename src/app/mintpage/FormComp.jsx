    ...
    <div>
      ...
      <form className="w-full max-w-2xl" onSubmit={handleSubmit}>
        ...
        <div className="flex flex-wrap -mx-3 mb-2">
          <div className="w-full px-3 flex items-center">
            ...
            <input
              // className="appearance-none block w-full bg-[#686784]   text-white border-2  border-custom_bg rounded py-1 px-4 mb-3 leading-tight focus:outline-none  "
              className="appearance-none block w-full bg-[#686784]   text-white border-2  py-1 px-4 mb-3 border-custom_bg rounded-xl"
              id="discordUrl"
              name="discordUrl"
              value={formData.discordUrl}
      ...
      <div className="flex flex-wrap -mx-3 my-3">
        <div className="w-full px-3 flex items-center">
          ...
          <input
            className="appearance-none block w-full bg-[#686784] text-white border-2 py-1 px-4 border-custom_bg rounded-xl"
            id="tokenAddress"
            name="tokenAddress"
            value={tokenAddress}
